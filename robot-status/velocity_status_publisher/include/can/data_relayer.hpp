...
class DataRelayer {
  ...
  public:
    ...
    void RegistVelocityCallback(void(*pfunc)(double));
 


    template<typename T>
    void RegistVelocityCallback(T * pClassType, void(T::*pfunc)(double)) {
          velocity_callback = move(bind(pfunc, pClassType
        , placeholders::_1
        ));
    }
  ...
  private:
    ...
    void Handler_VCU_Meter_Req(VCU_Vehicle_Status_2 msg);
