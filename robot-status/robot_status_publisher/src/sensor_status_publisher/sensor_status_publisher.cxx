...
robot_status_publisher::sensor::SensorStatusPublisher::SensorStatusPublisher(rclcpp::Node::SharedPtr main_node)
      : imu_cb_(nullptr),
      scan_cb_(nullptr),
      battery_state_cb_(nullptr)
{
    ...
    {
        RCLCPP_INFO(this->node_->get_logger(), "[%s] sub_node has been created", RCL_SENSOR_STATUS_PUBLISHER_NAME);
        RCLCPP_LINE_INFO();
    }
    else
    {
        RCUTILS_LOG_ERROR_NAMED(RCL_NODE_NAME, "failed to create %s sub_node", RCL_SENSOR_STATUS_PUBLISHER_NAME);
        RCLCPP_LINE_ERROR();
        exit(RCL_STOP_FLAG);
    }

    this->timer_ = this->node_->create_wall_timer(std::chrono::seconds(1), std::bind(&robot_status_publisher::sensor::SensorStatusPublisher::timer_callback, this));

    this->imu_status_publisher_cb_group_ = this->node_->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    ...
    this->imu_status_publisher_ = this->node_->create_publisher<robot_status_msgs::msg::SensorStatus>(
    ...
    this->imu_subscription_ = this->node_->create_subscription<sensor_msgs::msg::Imu>(
        ...
        std::bind(&robot_status_publisher::sensor::SensorStatusPublisher::imu_subscription_cb, this, _1),
        imu_subscription_opts);

    this->flag_rcl_connections(RCL_SUBSCRIPTION_FLAG, RCL_IMU_SUBSCRIPTION_TOPIC);

    this->scan_status_publisher_cb_group_ = this->node_->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    ...
    this->scan_status_publisher_ = this->node_->create_publisher<robot_status_msgs::msg::SensorStatus>(
    ...
    this->scan_subscription_ = this->node_->create_subscription<sensor_msgs::msg::LaserScan>(
        ...
        rclcpp::SensorDataQoS(),
        std::bind(&robot_status_publisher::sensor::SensorStatusPublisher::scan_subscription_cb, this, _1),
        scan_subscription_opts);

    this->flag_rcl_connections(RCL_SUBSCRIPTION_FLAG, RCL_SCAN_SUBSCRIPTION_TOPIC);

    this->gps_status_publisher_cb_group_ = this->node_->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    ...
    this->gps_status_publisher_ = this->node_->create_publisher<robot_status_msgs::msg::SensorStatus>(
    ...
    this->gps_subscription_ = this->node_->create_subscription<sensor_msgs::msg::NavSatFix>(
        ...
        rclcpp::SensorDataQoS(),
        std::bind(&robot_status_publisher::sensor::SensorStatusPublisher::gps_subscription_cb, this, _1),
        gps_subscription_opts);

    this->flag_rcl_connections(RCL_SUBSCRIPTION_FLAG, RCL_GPS_SUBSCRIPTION_TOPIC);

    this->battery_state_status_publisher_cb_group_ = this->node_->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    ...
    this->battery_state_status_publisher_ = this->node_->create_publisher<robot_status_msgs::msg::SensorStatus>(
    ...
    this->battery_error_status_subscription_cb_group_ = this->node_->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    ...
    this->battery_error_status_subscription_ = this->node_->create_subscription<robot_status_msgs::msg::SensorStatus>(
        RCL_BATTERY_ERROR_STATUS_SUBSCRIPTION_TOPIC,
        rclcpp::SensorDataQoS(),
        std::bind(&robot_status_publisher::sensor::SensorStatusPublisher::battery_error_status_subscription_cb, this, _1),
...
robot_status_publisher::sensor::SensorStatusPublisher::~SensorStatusPublisher()
{
}

void robot_status_publisher::sensor::SensorStatusPublisher::signal_handler(int signal_input)
{
...
void robot_status_publisher::sensor::SensorStatusPublisher::flag_rcl_connections(const char *connection_type, const char *connection_name)
{
    RCLCPP_INFO(this->node_->get_logger(), "RCL {%s} [%s - %s] created...", RCL_SENSOR_STATUS_PUBLISHER_NAME, connection_type, connection_name);
    RCLCPP_LINE_INFO();
}

void robot_status_publisher::sensor::SensorStatusPublisher::timer_callback()
{
...
std_msgs::msg::Header robot_status_publisher::sensor::SensorStatusPublisher::build_sensor_status_header(const char *header_frame_id)
{
...
robot_status_msgs::msg::SensorStatus robot_status_publisher::sensor::SensorStatusPublisher::build_sensor_status(const char *header_frame_id, int32_t status_code, const char *status_message)
{
...
void robot_status_publisher::sensor::SensorStatusPublisher::imu_subscription_cb(const sensor_msgs::msg::Imu::SharedPtr imu_subscription_cb_data)
{
    this->imu_cb_ = imu_subscription_cb_data;
}

void robot_status_publisher::sensor::SensorStatusPublisher::scan_subscription_cb(const sensor_msgs::msg::LaserScan::SharedPtr scan_subscription_cb_data)
{
    this->scan_cb_ = scan_subscription_cb_data;
}

void robot_status_publisher::sensor::SensorStatusPublisher::gps_subscription_cb(const sensor_msgs::msg::NavSatFix::SharedPtr gps_subscription_cb_data)
{
    this->gps_cb_ = gps_subscription_cb_data;
}

void robot_status_publisher::sensor::SensorStatusPublisher::battery_error_status_publish(int32_t status_code, const char *status_message)
{
...
void robot_status_publisher::sensor::SensorStatusPublisher::battery_error_status_subscription_cb(const robot_status_msgs::msg::SensorStatus::SharedPtr battery_error_status_subscription_cb_data)
{
